...
public class MovieLoader {
	private static final String MOVIES_CSV = "src/main/resources/movies_metadata.csv";
	...
	public static Dataset<Row> loadMovies(SparkSession spark) {
		...
		return spark.read().option("header", "true").option("inferSchema", "true").csv(MOVIES_CSV)
